...
<?php
   if (in_array("公告管理",$func_array))
   {
      if ($first_func_name == "公告管理")
         echo "<li class='active'><span class='tabIcon report'></span><span>公告管理</span></li>";
      else
         echo "<li><span class='tabIcon report'></span><span>公告管理</span></li>";
   }
   ...
   if (in_array("部门管理",$func_array))
   {
      if ($first_func_name == "部门管理")
         echo "<li class='active'><span class='tabIcon search'></span><span>部门管理</span></li>";
      else
         echo "<li><span class='tabIcon search'></span><span>部门管理</span></li>";
   }
   if (in_array("分类管理",$func_array))
   {
      if ($first_func_name == "分类管理")
         echo "<li class='active'><span class='tabIcon system'></span><span>分类管理</span></li>";
      else
         echo "<li><span class='tabIcon system'></span><span>分类管理</span></li>";
   }
   if (in_array("题目管理",$func_array))
   {
      if ($first_func_name == "题目管理")
         echo "<li class='active'><span class='tabIcon setting'></span><span>题目管理</span></li>";
      else
         echo "<li><span class='tabIcon setting'></span><span>题目管理</span></li>";
   }
   if (in_array("考卷管理",$func_array))
   {
      if ($first_func_name == "考卷管理")
         echo "<li class='active'><span class='tabIcon setting'></span><span>考卷管理</span></li>";
      else
         echo "<li><span class='tabIcon setting'></span><span>考卷管理</span></li>";
   }
...
<?php
   if (in_array("公告管理",$func_array))
   {
      ...
      if ($first_func_name == "公告管理")
         ...
         echo "none;'";
      echo ">";
      if (file_exists("News_list.php")) include("News_list.php");
      echo "</div>";
   }
   if (in_array("人员管理",$func_array))
   {
   ...
   if (in_array("题目管理",$func_array))
   {
      ...
      if ($first_func_name == "题目管理")
         ...
         echo "none;'";
      echo ">";
      if (file_exists("Problem\Problems_list.php")) include("Problem\Problems_list.php");
      echo "</div>";
   }
   if (in_array("考卷管理",$func_array))
   {
      ...
      if ($first_func_name == "考卷管理")
         ...
         echo "none;'";
      echo ">";
      if (file_exists("Exam\Exams_list.php")) include("Exam\Exams_list.php");
      echo "</div>";
   }
   if (in_array("后台权限管理",$func_array))
   {
